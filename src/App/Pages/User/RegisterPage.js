    ...
    return (
      <header className="navbar-buyer">
        <div className="navbar-buyer__logo">
          <NavLink exact to="/" className="navbar-buyer__logo-link">
            <svg
              viewBox="0 0 192 65"
              className="navbar-buyer__logo-icon shopee-svg-icon _3XB6zw _3d2_4f icon-shopee-logo"
            >
              <g fillRule="evenodd">
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className="authentication-form signUp">
                ...
                <div className="authentication-form__form">
                  ...
                  <div className="authentication-form__social">
                    <a
                      href
                      className="authentication-form__social-item authentication-form__social--facebook"
                    >
                      <i className="authentication-form__social-icon fab fa-facebook" />
                      <span className="authentication-form__social-name">
                        Facebook
                      </span>
                    </a>
                    <a
                      href
                      className="authentication-form__social-item authentication-form__social--google"
                    >
                      <i className="authentication-form__social-icon fab fa-google" />
                      <span className="authentication-form__social-name">
                        Google
                      </span>
                    </a>
                    <a
                      href
                      className="authentication-form__social-item authentication-form__social--apple"
                    >
                      <i className="authentication-form__social-icon fab fa-apple" />
                      <span className="authentication-form__social-name">
                        Apple
                      </span>
                    </a>
